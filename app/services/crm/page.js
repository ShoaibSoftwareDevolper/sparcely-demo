...
// const CRMPage = () => {
//     const crm = data.pages.services.crm;
...
//                         <span className="text-accent text-[10px] font-bold uppercase tracking-[1.5em] mb-16 block italic underline decoration-accent/30 underline-offset-20">Vertical / Operational Intelligence</span>
//                         <h1 className="text-7xl md:text-[15vw] font-black uppercase tracking-tighter leading-[0.8] mb-12">
//                             {crm.title.split(' ')[0]} <br />
//                             <span className="text-stroke tracking-normal">{crm.title.split(' ').slice(1).join(' ')}</span>
//                         </h1>
...
//                             <span className="text-accent text-[10px] font-bold uppercase tracking-[1em] mb-8 block italic">System Integration</span>
//                             <h2 className="text-7xl md:text-[8vw] font-black uppercase leading-[0.85] tracking-tighter">
//                                 Core <span className="text-stroke tracking-normal">Architectures.</span>
//                             </h2>
//                         </div>
//                     </FadeIn>
//                 </div>
...
//                                         <span className="text-muted/40 text-[10px] uppercase font-black tracking-[0.6em] block">System Valuation</span>
...
//                                     <span className="relative z-10 transition-colors duration-700">Initiate Protocol</span>
//                                     <div className="absolute inset-0 bg-white translate-y-full group-hover/btn:translate-y-0 transition-transform duration-700" />
//                                     <span className="absolute inset-0 flex items-center justify-center translate-y-full group-hover/btn:translate-y-0 transition-transform duration-700 text-black z-20 font-black">Initiate Protocol</span>
//                                 </Link>
//                             </div>
//                         </FadeIn>
//                     ))}
...
//                         <span className="text-accent text-[10px] font-bold uppercase tracking-[1em] mb-8 block italic">System Matrix</span>
//                         <h2 className="text-7xl md:text-[10vw] font-black uppercase leading-[0.85] tracking-tighter">
//                             Architectural <span className="text-stroke tracking-normal">Flow.</span>
//                         </h2>
//                     </div>
//                 </FadeIn>
...
//                 <FadeIn direction="up">
//                     <span className="text-accent text-[10px] font-bold uppercase tracking-[1.5em] mb-24 block text-center italic">Logic Stack / Intelligence Driven</span>
//                 </FadeIn>
//                 <div className="flex flex-wrap justify-center gap-x-24 gap-y-16 px-10 relative z-10 max-w-7xl">
//                     {crm.technologies.map((tech, index) => (
...
//              {/* Final CTA - LIQUID BOX */}
//             <section className="section-padding text-center relative overflow-hidden group/cta-final">
//                 <div className="absolute inset-0 bg-accent/5 opacity-0 group-hover/cta-final:opacity-100 transition-opacity duration-1000" />
//                 <FadeIn direction="up">
//                     <h2 className="text-6xl md:text-9xl font-black uppercase mb-16 tracking-tighter leading-none">Automate <br /><span className="text-stroke">Success.</span></h2>
//                 </FadeIn>
//                 <FadeIn direction="up" delay={0.1}>
//                     <p className="text-2xl md:text-3xl text-muted/60 max-w-3xl mx-auto mb-20 italic font-medium leading-tight">
//                         Connect your core product, service, or manufacturing workflows with a single, high-performance CRM solution.
//                     </p>
//                 </FadeIn>
//                 <FadeIn direction="up" delay={0.2}>
//                     <Link href="/contact" className="relative inline-flex items-center gap-10 bg-white/5 border border-white/10 px-20 py-10 rounded-full font-black uppercase text-[10px] tracking-[0.8em] hover:bg-accent group-hover:border-accent transition-all duration-700 group/link">
//                         <span>Discuss Integration</span>
//                         <div className="w-12 h-px bg-accent group-hover/link:w-20 transition-all duration-700" />
//                     </Link>
//                 </FadeIn>
//             </section>
//         </div>
