...
const SectionHeader = () => {
    return (
        <div className="site-padding pt-32 pb-20">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                <div className="lg:col-span-8">
                    <FadeIn direction="up">
                        ...
                        <h2 className="text-6xl md:text-[10vw] font-black uppercase leading-[0.75] tracking-tighter text-white">
                            SELECTED <br />
                ...
                <div className="lg:col-span-4 lg:flex lg:items-end lg:justify-end pb-4">
                    <FadeIn direction="up" delay={0.1}>
                        <p className="text-white/30 font-medium uppercase tracking-widest text-[10px] max-w-xs leading-relaxed lg:text-right">
                            We craft and execute marketing strategies from initial development to high-end creative design. Architectural precision in every project.
                        </p>
                    </FadeIn>
                </div>
            </div>
        ...
        >
            ...
            <div className="relative z-10 text-center px-10">
                <motion.div
                    ...
                    className="bg-black/40 backdrop-blur-3xl border border-white/10 p-6 md:p-12 max-w-2xl mx-auto group"
                >
                    <span className="font-mono text-[10px] text-accent font-bold uppercase tracking-[0.5em] mb-6 block">
                        [ FEATURED_CASE // 01 ]
                    </span>
                    <h2 className="text-3xl md:text-8xl font-black uppercase text-white mb-4 md:mb-8 tracking-tighter leading-none">
...
const ParallaxImages = ({ projects }) => {
    ...
    return (
        <div className="w-full pt-[80px] md:pt-[200px] grid grid-cols-1 md:grid-cols-2 gap-x-6 md:gap-x-20 gap-y-12 md:gap-y-40 site-padding">
            <ParallaxImg
                project={projects[0]}
                src={assets[0]}
                alt={projects[0]?.name}
            ...
            <ParallaxImg
                ...
                className="w-full md:w-11/12 md:mt-10"
            />
            <ParallaxImg
                project={projects[2]}
                src={assets[2]}
                ...
                className="w-full md:w-12/12 ml-auto"
            />
            <ParallaxImg
                project={projects[3]}
                src={assets[3]}
                ...
                className="w-full md:w-12/12 md:-mt-10"
            />
        </div>
    );
};
    ...
    return (
        ...
        >
            <div className="relative overflow-hidden bg-zinc-900 border border-white/5 transition-all duration-700 group-hover:border-accent/40">
                {isVideo ? (
                    <video src={src} autoPlay muted loop className="w-full h-[30vh] md:h-[55vh] object-cover opacity-60 group-hover:opacity-100 transition-opacity duration-700" />
                ) : (
                    <img src={src} alt={alt} className="w-full h-[30vh] md:h-[55vh] object-cover opacity-60 group-hover:opacity-100 transition-opacity duration-700" />
                )}

                <div className="absolute inset-0 p-5 md:p-10 flex flex-col justify-end bg-gradient-to-t from-black/90 via-black/20 to-transparent">
                    ...
                    <h3 className="text-2xl md:text-4xl font-black uppercase text-white mb-4 md:mb-6 group-hover:text-accent transition-colors duration-500 leading-none">
                        {project?.name}
                    </h3>
